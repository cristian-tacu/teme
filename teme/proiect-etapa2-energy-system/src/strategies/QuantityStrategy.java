...
public final class QuantityStrategy implements PickStrategy {
    private Distributor distributor;
    private Map<Integer, Producer> producers;
    private int month;

    QuantityStrategy(Distributor distributor, Map<Integer, Producer> producers, int month) {
    ...
    public void pickBestProducers() {
        ...
        // se sorteaza dupa Quntity si ID
