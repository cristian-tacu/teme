...
public final class PriceStrategy implements PickStrategy {
    private Distributor distributor;
    private Map<Integer, Producer> producers;
    private int month;

    PriceStrategy(Distributor distributor, Map<Integer, Producer> producers, int month) {
    ...
    /**
     * creeaza o lista pe baza mapei pentru sortare
     * @return noua lista
     */
    ...
    public void pickBestProducers() {
        ...
        // se sorteaza dupa Price, Quntity si ID
